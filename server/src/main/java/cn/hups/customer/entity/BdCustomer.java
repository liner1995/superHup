...
public class BdCustomer extends PagePoJo implements Serializable {
    ...
    public BdCustomer(Integer pkCustomer, String name, String code, String sex, String corpname, String corpaddress, String tel, String trade, String memo, Integer creator, String creationtime, Integer modifier, String modifiedtime, Integer dr, String ts) {
