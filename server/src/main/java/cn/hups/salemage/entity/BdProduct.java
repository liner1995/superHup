...
public class BdProduct extends PagePoJo implements Serializable {
    ...
    private Integer pcbLong;

    private Integer pcbWide;
    ...
    public BdProduct(Integer pkProduct, String name, String code, String model, Integer pkPsndoc, Integer purchaseContacts, Integer skillContacts, Integer smt, Integer dip, String isinstal, Integer instalMin, String istest, Integer testMin, String isaging, Integer agingMin, String exeStandard, String steelMeshSource, String defense, BigDecimal defenseArea, String sealTechnics, String materialSource, String ispcb, Integer pcbLong, Integer pcbWide, Integer pcbThick, String pcbResistColor, String pcbCharColor, String pcbResistCover, String pcbPadSpary, String pcbCopperThick, Integer pkCustomer, Integer orderNumber, String bomFilename, String bomFilefullname, String pcbFilename, String pcbFilefullname, String craftFilename, String craftFilefullname, String ismakeTool, String makeSteelMesh, String makeDip, String makeTest, String makeDefense, String makeAging, String taskId, Integer approver, String approvetime, Integer billState, Integer creator, String creationtime, Integer modifier, String modifiedtime, Integer dr, String ts) {
    ...
    public Integer getPcbLong() {
        return pcbLong;
    }

    public void setPcbLong(Integer pcbLong) {
        this.pcbLong = pcbLong;
    }

    public Integer getPcbWide() {
        return pcbWide;
    }

    public void setPcbWide(Integer pcbWide) {
        this.pcbWide = pcbWide;
    }
