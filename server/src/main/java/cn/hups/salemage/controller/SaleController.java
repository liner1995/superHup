...
public class SaleController {
    ...
    public AjaxJson saveProductFile(@RequestParam(required = false, value = "bomfile") MultipartFile bomfile,
                                    ...
                                    @RequestParam(required = false, value = "gongyifile") MultipartFile gongyifile) throws GlobalException {
        return iSaleService.saveProductFile(bomfile, pcbfile, gongyifile);
    }
